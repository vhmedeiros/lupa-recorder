...
1.6, 1.7, 1.8). Falta o teste de campo de 72h e validar `bootstrap.sh`/systemd/`bench` numa máquina
Debian limpa. DVB (1.3) adiado sem previsão (GRV-01). 241 testes. Ver
